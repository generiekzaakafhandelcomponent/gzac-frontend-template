    ...
    menuItems: [
      ...
      {roles: [ROLE_USER], link: ['/teams'], title: 'teams.title', iconClass: 'icon mdi mdi-account-group', sequence: 5},
      {
        roles: [ROLE_ADMIN], title: 'Admin', iconClass: 'icon mdi mdi-tune', sequence: 6, children: [
          ...
          {link: ['/notifications-api/notifications/failed'], title: 'Failed notifications', sequence: 12},

          {title: 'System processes', textClass: 'text-dark font-weight-bold c-default', sequence: 13},
